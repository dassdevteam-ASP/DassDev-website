    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
          ...
          <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-medium text-white transition-opacity duration-200 group-hover:opacity-70">
            Explore project
...
function ProjectDetailSection({ number, title, children, last = false }) {
  return (
    <section className={last ? "" : "border-b border-border pb-8 mb-8"}>
